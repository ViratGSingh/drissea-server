...
export class NewsSerpData extends OpenAPIRoute {
  schema = {
    tags: ["Serp Search"],
    ...
    try {
      ...
      const [
        ...
        fetch(
          ...
          }&engine=google_news_light&gl=${countryCode}&location=${country}&safe=off&device=mobile`,
          {
            method: "GET",
            headers: {
              "Content-Type": "application/json",
      ...
      const [
        ...
        newsRes.json() as Promise<NewsSerpResponse>,
      ]);
