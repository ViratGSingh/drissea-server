...
export class UpdGenAnswer extends OpenAPIRoute {
  schema = {
...
4. ✅ For every factual claim or key insight derived from the video content, include an inline citation by wrapping the relevant **phrase or word** in a Markdown hyperlink pointing to the source's "Content Url". Use the format:  
